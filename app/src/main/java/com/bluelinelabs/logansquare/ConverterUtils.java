...
/**
 * Utility class for the {@link com.fuzz.anthonyfermin.starwarsgraphql.LoganSquareConverterFactory}. This resides in LoganSquare's
...
public final class ConverterUtils {
    ...
    public static boolean isSupported(Type type) {
        if (type instanceof Class && ResponseBody.class.equals(type)) {
            return true;
        }
